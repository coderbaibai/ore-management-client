...
from models.UploadHeader import UploadHeader
from models.UploadTable import UploadTable

from utils.S3Utils import s3Utils
from utils.SqliteUtils import *

class UploadWidget(SubtitleLabel):
    def __init__(self,text:str,parent=None):
        super().__init__(parent=parent)
        self.setObjectName(text.replace(' ', '-'))
        self.vLayout = QVBoxLayout(self)
        self.header = UploadHeader(self)
        self.table = UploadTable(self)
    ...
    def start_upload(self,bucket,path,data):
        self.table.start_upload(bucket,path,data)